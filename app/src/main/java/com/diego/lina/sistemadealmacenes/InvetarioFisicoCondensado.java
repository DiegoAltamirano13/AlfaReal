...
public class InvetarioFisicoCondensado extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    ProgressDialog progressDialog;
    RequestQueue requestQueue;
    CardView cardView;
    FloatingActionButton floatingActionButton;

    Button btn_buscar_condensado;
    boolean click = false;

    ArrayList<String> arrayListPlazasCondensado;
    Spinner spinnerInvFisCondensado;
    String as_usr, as_password, as_plaza;
    ...
    @Override
    public void onCreate(Bundle saveInstanceEstate){
        super.onCreate(saveInstanceEstate);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        floatingActionButton = fragmento.findViewById(R.id.expandablebutton);
        ...
        arrayListPlazasCondensado = new ArrayList<>();
        spinnerInvFisCondensado = fragmento.findViewById(R.id.plaza_InvFis);
        ...
        btn_buscar_condensado = fragmento.findViewById(R.id.buscarInvFis);
        btn_buscar_condensado.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                click = !click;
        ...
        editTextNuSER = fragmento.findViewById(R.id.invFisText);
        editTextNuSER.setText(preferences.getString("as_nombre", "No tiene"));
    ...
    private void llenar_spinnerPlazasInvFis() {
        ...
        SharedPreferences preferences = this.getActivity().getSharedPreferences("as_usr_nombre", Context.MODE_PRIVATE);
        as_usr = (preferences.getString("as_usr_nombre", "No tiene nombre "));
        as_password = (preferences.getString("as_password", "No tiene nombre "));

        StringRequest stringRequest = new StringRequest(Request.Method.GET, ClassConection.URL_WEBB_SERVICES + "plazas_clientes.php?usr_usuario="+as_usr+"&usr_password="+as_password, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        arrayListPlazasCondensado.add(country);
                    }
                    spinnerInvFisCondensado.setAdapter(new ArrayAdapter<String>(getContext(), R.layout.support_simple_spinner_dropdown_item, arrayListPlazasCondensado));
    ...
    private void cargarTablaInvFis() {
        ...
        SharedPreferences preferences = this.getActivity().getSharedPreferences("as_usr_nombre", Context.MODE_PRIVATE);
        as_usr = editTextNuSER.getText().toString();
        as_plaza = spinnerInvFisCondensado.getSelectedItem().toString();

        String url = ClassConection.URL_WEBB_SERVICES + "inv_fis_condensado_total.php?cliente="+as_usr+ "&plaza="+as_plaza;
